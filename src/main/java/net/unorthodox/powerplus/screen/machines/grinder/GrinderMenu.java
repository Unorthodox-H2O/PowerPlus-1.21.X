...
public class GrinderMenu extends AbstractContainerMenu {
    ...
    public GrinderMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 0, 71, 16));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 1, 72, 58));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 2, 28, 55));
    ...
    public int getScaledGearProgress() {
        int progress = this.data.get(0);
        int maxProgress = this.data.get(1);
        int gearPixelSize = 16;

        return maxProgress != 0 && progress != 0 ? progress * gearPixelSize / maxProgress : 0;
    }
