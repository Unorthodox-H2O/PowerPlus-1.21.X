...
import net.unorthodox.powerplus.block.entity.machines.CoalGrinderBlockEntity;
import net.unorthodox.powerplus.screen.ModMenuTypes;

public class CoalGrinderMenu extends AbstractContainerMenu {
    public final CoalGrinderBlockEntity blockEntity;
    ...
    public CoalGrinderMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.COAL_GRINDER_MENU.get(), pContainerId);
        blockEntity = ((CoalGrinderBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.COALGRINDER.get());
    }
