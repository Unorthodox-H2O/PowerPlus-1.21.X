...
public record CrystalInfuserRecipe(Ingredient inputItem, ItemStack output) implements Recipe<CrystalInfuserRecipeInput> {
    ...
    @Override
    public boolean matches(CrystalInfuserRecipeInput pInput, Level pLevel) {
    ...
    @Override
    public ItemStack assemble(CrystalInfuserRecipeInput pInput, HolderLookup.Provider pRegistries) {
        return output.copy();
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipes.CRYSTALINFUSER_SERIALIZER.get();
    }

    @Override
    public RecipeType<?> getType() {
        return ModRecipes.CRYSTALINFUSER_TYPE.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<CrystalInfuserRecipe> {
        public static final MapCodec<CrystalInfuserRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                Ingredient.CODEC_NONEMPTY.fieldOf("ingredient").forGetter(CrystalInfuserRecipe::inputItem),
