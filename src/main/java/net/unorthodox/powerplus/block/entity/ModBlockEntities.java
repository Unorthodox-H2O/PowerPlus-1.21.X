...
public class ModBlockEntities {
    ...
    public static final Supplier<BlockEntityType<CoalGrinderBlockEntity>> COAL_GRINDER_BE =
            BLOCK_ENTITIES.register("crystal_infuser_be", () -> BlockEntityType.Builder.of(
                    CrystalInfuserBlockEntity::new, ModBlocks.COAL_GRINDER.get()).build(null));
